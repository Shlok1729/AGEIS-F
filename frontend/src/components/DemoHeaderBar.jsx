  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <span
            ...
            style={{
              ...
              height: 6,
              borderRadius: '50%',
              background: teeArmed ? 'var(--green)' : 'var(--overlay1)',
          ...
          <span className="badge badge--dim" style={{ fontSize: 9 }}>FCC MODE=0</span>
        </div>

        <span style={{ color: 'rgba(255, 255, 255, 0.1)' }}>|</span>

        <div>
          <span style={{ color: 'var(--overlay1)' }}>FTSOv2 FLR/USD: </span>
        ...
        <div>
          <span style={{ color: 'var(--overlay1)' }}>Latency: </span>
          <span style={{ color: 'var(--text)', fontWeight: 600, fontFamily: 'var(--font-mono)' }}>&lt;340ms</span>
        </div>

        <span style={{ color: 'rgba(255, 255, 255, 0.1)' }}>|</span>

        <div>
          <span style={{ color: 'var(--overlay1)' }}>TEE PMW: </span>
          <span style={{ color: 'var(--text)', fontWeight: 600, fontFamily: 'var(--font-mono)' }}>
        ...
        {account && (
          <>
            <span style={{ color: 'rgba(255, 255, 255, 0.1)' }}>|</span>
            <div>
              <span style={{ color: 'var(--overlay1)' }}>Borrower: </span>
              <span style={{ color: 'var(--mauve)', fontWeight: 600, fontFamily: 'var(--font-mono)' }}>
